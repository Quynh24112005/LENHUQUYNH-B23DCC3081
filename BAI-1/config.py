...
# Mapping URL suffix cho từng loại bảng
TABLE_URLS = { 
    TABLE_IDS['standard']: PL_SUFFIX, # Bảng standard dùng suffix chung
...
# Ánh xạ tên cột từ file CSV mẫu sang data-stat của fbref
HEADER_MAP = { 
    'Player': 'player',
    'Nation': 'nationality',
    'Team': 'team',
...
# Thứ tự cột header cuối cùng theo file CSV mẫu
HEADER_ORDER = [ 
...
# Tạo danh sách các data_stat theo đúng thứ tự của header CSV mẫu
EXPORT_STATS = [] 
fetched_stats = set() # Để đảm bảo lấy đủ dữ liệu unique 
...
# Phân loại các data-stat cần lấy theo bảng gốc trên fbref
STATS_BY_TABLE = {
    TABLE_IDS['standard']: [
